...
class AnalysisForm(FlaskForm):
    data = TextAreaField(label='data',id="userInput", render_kw={'placeholder':'Type synonymous mutations as VCF format','class_':"layui-textarea", 'style':'height:120px', 'autocomplete':"off",})
    email = StringField(label='eMail', id='eMail',
                            render_kw={'autocomplete': 'off','class_': 'layui-input', 'style':"border-radius: 0;",'placeholder':"Please input Email address"})
