...
@searchblue.route('/dbDSMv2/search', methods=['GET', 'POST'])
def search():
    '''
...
@searchblue.route('/dbDSMv2/searchSubmit', methods=['GET', 'POST'])
def searchSubmit():
    '''
    普通查询首次提交
...
@searchblue.route('/dbDSMv2/searchTable', methods=['GET', 'POST'])
...
@searchblue.route('/dbDSMv2/detailScore', methods=['GET', 'POST'])
def detailScore():
...
@searchblue.route('/dbDSMv2/advancedSearch', methods=['GET', 'POST'])
def advancedSearch():
...
@searchblue.route('/dbDSMv2/advancedSearchTable', methods=['GET', 'POST'])
...
@searchblue.route('/dbDSMv2/researchDisease', methods=['GET', 'POST'])
def researchDisease():
    Disease = request.args.get("Disease")
    dict = {
        'Disease': Disease
...
@searchblue.route('/dbDSMv2/researchGene', methods=['GET', 'POST'])
def researchGene():
...
# @searchblue.route('/dbDSMv2/resetPageLimit1', methods=['GET', 'POST'])
# def resetPageLimit1():
